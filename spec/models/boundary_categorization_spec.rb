...
RSpec.describe "boundary FIPS-199 categorization (#940)" do
  ...
  def information_type(confidentiality: nil, integrity: nil, availability: nil,
                       base_confidentiality: nil)
    SspInformationType.create!(
      ...
      confidentiality_impact_selected: confidentiality,
      integrity_impact_selected: integrity,
      availability_impact_selected: availability,
      confidentiality_impact_base: base_confidentiality
    )
  end
  ...
  describe "the high water mark" do
    ...
    it "takes the HIGHEST impact across all three objectives" do
      information_type(confidentiality: "fips-199-low",
    ...
    it "takes the highest across MULTIPLE information types, not the last one" do
      information_type(confidentiality: "fips-199-low")
      information_type(confidentiality: "fips-199-moderate")
    ...
    it "is low only when everything is low" do
      information_type(confidentiality: "fips-199-low", integrity: "fips-199-low",
                       availability: "fips-199-low")
  ...
  describe "selected overrides base" do
    ...
    it "prefers the owner's selected impact over the 800-60 provisional base" do
      information_type(confidentiality: "fips-199-low", base_confidentiality: "fips-199-high")
    ...
    it "falls back to the provisional base when nothing was selected" do
      information_type(base_confidentiality: "fips-199-moderate")
  ...
  describe "conflict detection" do
    it "flags a stored level that contradicts the information types" do
      ...
      information_type(confidentiality: "fips-199-high")
