...
282 issues that document referenced were already closed** — 88% of it was
history, and the 34 live items were hard to find inside it. The plan now carries
only what is in flight; this carries the rest.
...
### Phase 12: Active Backlog — Post-migration Test/CI Hardening + Federation Follow-ups (COMPLETE)
...
### Phase 14: Pre-Public-Flip + API Test Validation + CDEF Mutations (COMPLETE)
...
**FINAL: 87 issues, 87 closed — measured 2026-08-24 after the tag**
(86 at the moment of tagging; #1056 was moved onto the milestone afterwards,
because its fix shipped in v1.16.0 even though it was filed against v1.16.1.)
