...
**Open: 8. Closed: 3.** Re-measured 2026-09-21 from ONE grouped query
...
**517 are closed**, **35 open**. What remains:
...
The reconciliation: 0 + 8 + 8 + 19 = 35, and 517 + 35 = 552 (re-measured 2026-09-21 with the AG bundle PR; #1144 and #1164 closed with PR #1165, #1155 and #1162 close with this one).
