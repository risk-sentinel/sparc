...
**Open: 3. Closed: 19.** Measured 2026-09-17 with
...
| Open, on `v1.16.1` | **3** — 19 of its 22 are closed; the three open are Bundle AD, in one PR |
