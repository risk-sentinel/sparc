...
**Open: 7. Closed: 5.** Re-measured 2026-09-21 from ONE grouped query
...
The reconciliation: 0 + 7 + 8 + 19 = 34, and 519 + 34 = 553 (re-measured 2026-09-21 with the AH bundle PR; #1155 and #1162 closed with PR #1171, #1161 and #1159 close with this one, and **#1172 was filed onto v1.17.0** — FedRAMP KSI schema ingestion, the capability whose absence produced #1115's drift).
