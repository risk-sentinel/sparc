...
**Open: 14. Closed: 6.** Measured 2026-09-10 with
`gh issue list --milestone v1.16.1 --state all --limit 300`. **This is the
current phase**, and it is running: Bundle Y is shipped, **Bundle Z is
DELIVERED** — PR #1110 merged 2026-09-10, closing #1047, #728, #1113 and #980.
...
| 18 | **In progress** | v1.16.1 — the patch release | **14 open, 6 closed** on the milestone (re-measured 2026-09-10, `gh issue list --milestone v1.16.1 --state all --limit 300`). **Y SHIPPED 2026-08-31** — all four (#968 #1051 #1022 #1058) closed in ONE day against a 3d estimate. **Z DELIVERED 2026-09-10** via [PR #1102](https://github.com/risk-sentinel/sparc/pull/1102) then [PR #1110](https://github.com/risk-sentinel/sparc/pull/1110): #1047 closed at **1,262 of 1,516 swept (83%)** — every file holding ten or more is at zero, the 254-declaration tail is #1109 on v1.17.1 — plus #728, #1113 and #980. **#1046 moved to v1.17.1** (owner, 09-10). Z folded in six spot-check issues (#1090 #1092 #1093 #1094 #1095 #1096) and filed six more out of its own work (#1103 #1104 #1105 #1106 #1116 #1117). Bundles: ~~Y~~ · ~~Z~~ · AA auth and access debt (#978 #1044 #1059 #1082) · AB onboarding and Sonar (#1040 #940 #1033 #930 #966 #836) · **AC #1063 #1106 — unsequenced, no owner decision** | Estimated **14 working days**, target **~2026-09-22 and soft**. **Re-measured after Z:** Y ran 3d → **1d**; Z ran 4d → **10d**, and the overrun was NOT the sweep — it was the OSCAL assessment chain an owner screen-review uncovered, which no issue described when Z was scoped. **AA is now the governing bundle.** Re-measure any sweep figure by RUNNING `spec/views/inline_style_ratchet_spec.rb`, never by reading it out of this file, which was stale within two days last time — and was stale again when Z merged |
