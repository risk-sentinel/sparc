...
**Open: 10. Closed: 1.** Re-measured 2026-09-20 from ONE grouped query
...
Re-measured against the live repository, not carried forward. **552 issues**;
**515 are closed**, **37 open**. What remains:
...
The reconciliation: 0 + 10 + 8 + 19 = 37, and 515 + 37 = 552 (re-measured 2026-09-20 with the bundle PR for #1144/#1164; v1.17.0 holds 10 open because #1164 joined it after the sweep).
