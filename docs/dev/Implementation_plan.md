...
**Open: 6. Closed: 0.** Measured 2026-09-17 with
`gh issue list --milestone v1.17.0 --state all --limit 300`. **This is the
current phase.** Every issue on it was *moved* here by an owner decision or
