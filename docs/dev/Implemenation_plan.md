...
### Action owed the moment Bundle D merges

- **Push the wiki mirror — `./wiki/PUSH_TO_WIKI.sh`.** DECIDED with the owner
  2026-08-12: do not wait for the release. The published wiki was last pushed
