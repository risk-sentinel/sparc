...
| **P3** | [ ] | #449 | HDF ↔ OSCAL translation bridge for tenant compliance pipelines (#447 lean spinout) | Filed 2026-05-06 as the lean variant of #447. Tenant owns their HDF lifecycle (uses MITRE `hdf` CLI directly); SPARC accepts amended HDFs and emits disposition-aware OSCAL SAR / OSCAL POAM with back-matter, related-risks, and `disposition` / `effectiveImpact` fields. Reverse direction: accept OSCAL POAM, emit HDF Amendments JSON (`hdf convert --from oscal-poam`). Existing SPARC Evidence/Attestation records flow into OSCAL back-matter when present. **No new domain models; no triage UI; no hosted disposition state.** ~500 LOC, 6 slices (L1-L6), single PR. Targets release v1.6.0. |
...
| 12 | Current | Active Backlog — Post-migration Test/CI Hardening + Federation Follow-ups | ~~#436~~, ~~#244~~, ~~#367~~, ~~#445~~, ~~#440~~, #449, #447 (Plan B), #433, #341, #246, #422, #413 | In Progress |

<!-- markdownlint-enable MD013 -->

**Total issues tracked:** 69 (23 original + 46 ad-hoc/new — adds #436, #445, #440, #447, #449)
**Completed (Phases 1-11 + ad-hoc):** 73 issues (incl. #415 Scenario A + #416 + #423 + #424 POAM completion — completed 2026-04-27; #419 SPARC_HASH master-key rotation rake — completed 2026-04-25; #430 GitHub org migration completed 2026-05-02; #436 CI consolidating-gate pattern completed 2026-05-05; #244 security gate + #367 coverage threshold completed 2026-05-06; #445 PR checklist hygiene completed 2026-05-06; #440 CMS attestation export completed 2026-05-06)
**Remaining (Phase 12 active backlog):** 7 issues — P1: #433 / P2: #341, #246 / P3: #449 (HDF↔OSCAL translation bridge — active, targets v1.6.0), #447 (Plan B / hosted-disposition workflow with UI — deferred), #422 (gated on first federation deployment), #413 (umbrella; closes on #433 merge)
