...
| `type_use_as` | `implemented-requirements[].props[name=control-type]` | ns: `https://sparc.local/ns` |
| `provided_as` | `implemented-requirements[].props[name=provided-as]` | ns: `https://sparc.local/ns` |
| `control_origination` | `implemented-requirements[].props[name=control-origination]` | ns: `https://sparc.local/ns` |
...
| SspControlField `field_name` | OSCAL JSON Path | Notes |
|------------------------------|----------------|-------|
| `private_implementation` | `...statements[statement-id={control-id}_priv].remarks` | Private implementation narrative |
| `public_implementation` | `...statements[statement-id={control-id}_pub].remarks` | Public implementation narrative |
