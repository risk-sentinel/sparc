...
- **Documentation:** **236 / 279** endpoints are listed in an `endpoints/*.md` page's own Endpoints table (**85%**); 24 more are mentioned only in prose
- **Postman collection:** **279 / 279** endpoints covered (**100%**)
- **Pytest suite:** **237 / 279** endpoints map to a `tests/api/test_*.py` module (**85%**)
...
### No pytest module — 42 endpoints across 22 controllers
