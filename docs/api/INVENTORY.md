...
- **Code:** **221 logical endpoints** across 45 controller groups (PATCH+PUT aliases collapsed) — 85 GET, 78 POST, 30 DELETE, 26 PUT, 24 PATCH
- **Documentation:** **178 / 221** endpoints are listed in an `endpoints/*.md` page's own Endpoints table (**81%**); 24 more are mentioned only in prose
- **Postman collection:** **216 / 221** endpoints covered (**98%**)
- **Pytest suite:** **182 / 221** endpoints map to a `tests/api/test_*.py` module (**82%**)
...
### Not in the Postman collection — 5 endpoints
...
| `GET` | `/api/v1/roles` | `roles#index` | [`roles.md`](endpoints/roles.md) | **MISSING** | yes |
| `POST` | `/api/v1/roles` | `roles#create` | [`roles.md`](endpoints/roles.md) | **MISSING** | yes |
| `DELETE` | `/api/v1/roles/:id` | `roles#destroy` | [`roles.md`](endpoints/roles.md) | **MISSING** | yes |
| `GET` | `/api/v1/roles/:id` | `roles#show` | [`roles.md`](endpoints/roles.md) | **MISSING** | yes |
| `PATCH/PUT` | `/api/v1/roles/:id` | `roles#update` | [`roles.md`](endpoints/roles.md) | **MISSING** | yes |
