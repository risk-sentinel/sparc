...
- **Generated:** 2026-09-21 from `bin/rails routes` on this commit
- **Code:** **307 logical endpoints** across 62 controller groups (PATCH+PUT aliases collapsed) — 119 GET, 104 POST, 43 DELETE, 39 PUT, 37 PATCH
- **Documentation:** **290 / 307** endpoints are listed in an `endpoints/*.md` page's own Endpoints table (**94%**); 17 more are mentioned only in prose
- **Postman collection:** **307 / 307** endpoints covered (**100%**)
- **Pytest suite:** **307 / 307** endpoints map to a `tests/api/test_*.py` module (**100%**)
...
### Documented nowhere — 0 endpoints
...
### Mentioned in prose but not published — 17 endpoints
...
| Method | Path | Page |
|---|---|---|
| `GET` | `/api/v1/authorization_boundaries/:authorization_boundary_id/readiness` | [`boundary-readiness.md`](endpoints/boundary-readiness.md) |
...
| `GET` | `/api/v1/federation/identity` | [`federation-identity.md`](endpoints/federation-identity.md) |
...
| `GET` | `/api/v1/admin/reconciliation` | `admin/reconciliation#index` | [`admin-reconciliation.md`](endpoints/admin-reconciliation.md) | yes | yes |
| `GET` | `/api/v1/admin/remediation_timelines` | `admin/remediation_timelines#index` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
| `PUT` | `/api/v1/admin/remediation_timelines` | `admin/remediation_timelines#update` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
| `POST` | `/api/v1/authorization_boundaries/:authorization_boundary_id/aggregate` | `aggregations#create` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
...
| `GET` | `/api/v1/artifacts/:uuid/freshness` | `artifacts#freshness` | [`artifacts.md`](endpoints/artifacts.md) | yes | yes |
| `GET` | `/api/v1/artifacts/:uuid/versions` | `artifacts#versions` | [`artifacts.md`](endpoints/artifacts.md) | yes | yes |
...
| `GET` | `/api/v1/authoritative_sources` | `authoritative_sources#index` | [`authoritative-sources.md`](endpoints/authoritative-sources.md) | yes | yes |
| `POST` | `/api/v1/authoritative_sources` | `authoritative_sources#create` | [`authoritative-sources.md`](endpoints/authoritative-sources.md) | yes | yes |
| `DELETE` | `/api/v1/authoritative_sources/:id` | `authoritative_sources#destroy` | [`authoritative-sources.md`](endpoints/authoritative-sources.md) | yes | yes |
| `GET` | `/api/v1/authoritative_sources/:id` | `authoritative_sources#show` | [`authoritative-sources.md`](endpoints/authoritative-sources.md) | yes | yes |
| `PATCH/PUT` | `/api/v1/authoritative_sources/:id` | `authoritative_sources#update` | [`authoritative-sources.md`](endpoints/authoritative-sources.md) | yes | yes |
| `POST` | `/api/v1/authoritative_sources/:id/restore` | `authoritative_sources#restore` | [`authoritative-sources.md`](endpoints/authoritative-sources.md) | yes | yes |
...
| `PATCH` | `/api/v1/authorization_boundaries/:id/organization` | `authorization_boundaries#assign_organization` | [`authorization-boundaries.md`](endpoints/authorization-boundaries.md) | yes | yes |
...
| `GET` | `/api/v1/authorization_boundaries/:authorization_boundary_id/readiness` | `boundary_readiness#show` | prose only — [`boundary-readiness.md`](endpoints/boundary-readiness.md) | yes | yes |
...
| `PATCH` | `/api/v1/cdef_documents/:id/scope` | `cdef_documents#update_scope` | [`cdef-documents.md`](endpoints/cdef-documents.md) | yes | yes |
...
| `GET` | `/api/v1/control_mappings/:control_mapping_id/entries` | `control_mapping_entries#index` | [`control-mappings.md`](endpoints/control-mappings.md) | yes | yes |
| `POST` | `/api/v1/control_mappings/:control_mapping_id/entries` | `control_mapping_entries#create` | [`control-mappings.md`](endpoints/control-mappings.md) | yes | yes |
| `DELETE` | `/api/v1/control_mappings/:control_mapping_id/entries/:id` | `control_mapping_entries#destroy` | [`control-mappings.md`](endpoints/control-mappings.md) | yes | yes |
| `PATCH/PUT` | `/api/v1/control_mappings/:control_mapping_id/entries/:id` | `control_mapping_entries#update` | [`control-mappings.md`](endpoints/control-mappings.md) | yes | yes |
...
| `GET` | `/api/v1/converters/:converter_id/entries` | `converter_entries#index` | [`converters.md`](endpoints/converters.md) | yes | yes |
| `POST` | `/api/v1/converters/:converter_id/entries` | `converter_entries#create` | [`converters.md`](endpoints/converters.md) | yes | yes |
| `DELETE` | `/api/v1/converters/:converter_id/entries/:id` | `converter_entries#destroy` | [`converters.md`](endpoints/converters.md) | yes | yes |
| `GET` | `/api/v1/converters` | `converters#index` | [`converters.md`](endpoints/converters.md) | yes | yes |
| `POST` | `/api/v1/converters` | `converters#create` | [`converters.md`](endpoints/converters.md) | yes | yes |
| `DELETE` | `/api/v1/converters/:id` | `converters#destroy` | [`converters.md`](endpoints/converters.md) | yes | yes |
| `GET` | `/api/v1/converters/:id` | `converters#show` | [`converters.md`](endpoints/converters.md) | yes | yes |
| `PATCH/PUT` | `/api/v1/converters/:id` | `converters#update` | [`converters.md`](endpoints/converters.md) | yes | yes |
| `GET` | `/api/v1/converters/:id/export` | `converters#export` | [`converters.md`](endpoints/converters.md) | yes | yes |
| `POST` | `/api/v1/converters/:id/refresh` | `converters#refresh` | [`converters.md`](endpoints/converters.md) | yes | yes |
| `GET` | `/api/v1/available` | `discovery#available` | [`discovery.md`](endpoints/discovery.md) | yes | yes |
| `GET` | `/api/v1/entitlement_sync` | `entitlement_sync#show` | [`entitlement-sync.md`](endpoints/entitlement-sync.md) | yes | yes |
| `POST` | `/api/v1/entitlement_sync/preview` | `entitlement_sync#preview` | [`entitlement-sync.md`](endpoints/entitlement-sync.md) | yes | yes |
...
| `GET` | `/api/v1/federation/identity` | `federation_identities#show` | prose only — [`federation-identity.md`](endpoints/federation-identity.md) | yes | yes |
...
| `DELETE` | `/api/v1/scanner_findings/:scanner_finding_id/disposition` | `finding_dispositions#destroy` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
| `GET` | `/api/v1/scanner_findings/:scanner_finding_id/disposition` | `finding_dispositions#show` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
| `POST` | `/api/v1/scanner_findings/:scanner_finding_id/disposition` | `finding_dispositions#create` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
| `POST` | `/api/v1/scanner_findings/:scanner_finding_id/disposition/approve` | `finding_dispositions#approve` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
| `POST` | `/api/v1/scanner_findings/:scanner_finding_id/disposition/reject` | `finding_dispositions#reject` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
| `GET` | `/api/v1/guides` | `guides#index` | [`guides.md`](endpoints/guides.md) | yes | yes |
| `GET` | `/api/v1/guides/:slug` | `guides#show` | [`guides.md`](endpoints/guides.md) | yes | yes |
| `GET` | `/api/v1/authorization_boundaries/:authorization_boundary_id/hdf_amendments` | `hdf_amendments#show` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
| `GET` | `/api/v1/authorization_boundaries/:authorization_boundary_id/hdf_package` | `hdf_packages#show` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
| `GET` | `/api/v1/idp_grants/unmatched` | `idp_grants#unmatched` | [`idp-grants.md`](endpoints/idp-grants.md) | yes | yes |
...
| `GET` | `/api/v1/authorization_boundaries/:authorization_boundary_id/leveraged_authorizations` | `leveraged_authorizations#index` | [`leveraged-authorizations.md`](endpoints/leveraged-authorizations.md) | yes | yes |
| `POST` | `/api/v1/authorization_boundaries/:authorization_boundary_id/leveraged_authorizations` | `leveraged_authorizations#create` | [`leveraged-authorizations.md`](endpoints/leveraged-authorizations.md) | yes | yes |
| `DELETE` | `/api/v1/authorization_boundaries/:authorization_boundary_id/leveraged_authorizations/:id` | `leveraged_authorizations#destroy` | [`leveraged-authorizations.md`](endpoints/leveraged-authorizations.md) | yes | yes |
| `GET` | `/api/v1/authorization_boundaries/:authorization_boundary_id/leveraged_authorizations/:id` | `leveraged_authorizations#show` | [`leveraged-authorizations.md`](endpoints/leveraged-authorizations.md) | yes | yes |
| `POST` | `/api/v1/authorization_boundaries/:authorization_boundary_id/leveraged_authorizations/:id/populate` | `leveraged_authorizations#populate` | [`leveraged-authorizations.md`](endpoints/leveraged-authorizations.md) | yes | yes |
| `GET` | `/api/v1/organizations` | `organizations#index` | [`organizations.md`](endpoints/organizations.md) | yes | yes |
...
| `GET` | `/api/v1/poam_documents/:poam_document_id/findings/:id` | `poam_findings#show` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/findings/:id` | `poam_findings#update` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `GET` | `/api/v1/poam_documents/:poam_document_id/items` | `poam_items#index` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `POST` | `/api/v1/poam_documents/:poam_document_id/items` | `poam_items#create` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/items/:id` | `poam_items#destroy` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `GET` | `/api/v1/poam_documents/:poam_document_id/items/:id` | `poam_items#show` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/items/:id` | `poam_items#update` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `GET` | `/api/v1/poam_documents/:poam_document_id/local_components` | `poam_local_components#index` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `POST` | `/api/v1/poam_documents/:poam_document_id/local_components` | `poam_local_components#create` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/local_components/:id` | `poam_local_components#destroy` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `GET` | `/api/v1/poam_documents/:poam_document_id/local_components/:id` | `poam_local_components#show` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/local_components/:id` | `poam_local_components#update` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `GET` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones` | `poam_milestones#index` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `POST` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones` | `poam_milestones#create` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones/:id` | `poam_milestones#destroy` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `GET` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones/:id` | `poam_milestones#show` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones/:id` | `poam_milestones#update` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `GET` | `/api/v1/poam_documents/:poam_document_id/observations` | `poam_observations#index` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `POST` | `/api/v1/poam_documents/:poam_document_id/observations` | `poam_observations#create` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/observations/:id` | `poam_observations#destroy` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `GET` | `/api/v1/poam_documents/:poam_document_id/observations/:id` | `poam_observations#show` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/observations/:id` | `poam_observations#update` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `GET` | `/api/v1/poam_documents/:poam_document_id/remediations` | `poam_remediations#index` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `POST` | `/api/v1/poam_documents/:poam_document_id/remediations` | `poam_remediations#create` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/remediations/:id` | `poam_remediations#destroy` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `GET` | `/api/v1/poam_documents/:poam_document_id/remediations/:id` | `poam_remediations#show` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/remediations/:id` | `poam_remediations#update` | [`poam-subresources.md`](endpoints/poam-subresources.md) | yes | yes |
...
| `GET` | `/api/v1/roles/:id` | `roles#show` | [`roles.md`](endpoints/roles.md) | yes | yes |
| `PATCH/PUT` | `/api/v1/roles/:id` | `roles#update` | [`roles.md`](endpoints/roles.md) | yes | yes |
...
| `POST` | `/api/v1/sar_documents/:id/fields/import/confirm` | `sar_documents#import_fields_confirm` | prose only — [`field-import.md`](endpoints/field-import.md) | yes | yes |
...
| `GET` | `/api/v1/sar_documents/:sar_document_id/risks` | `sar_risks#index` | [`sar-risks.md`](endpoints/sar-risks.md) | yes | yes |
| `POST` | `/api/v1/sar_documents/:sar_document_id/risks` | `sar_risks#create` | [`sar-risks.md`](endpoints/sar-risks.md) | yes | yes |
| `DELETE` | `/api/v1/sar_risks/:id` | `sar_risks#destroy` | [`sar-risks.md`](endpoints/sar-risks.md) | yes | yes |
| `GET` | `/api/v1/sar_risks/:id` | `sar_risks#show` | [`sar-risks.md`](endpoints/sar-risks.md) | yes | yes |
| `PATCH/PUT` | `/api/v1/sar_risks/:id` | `sar_risks#update` | [`sar-risks.md`](endpoints/sar-risks.md) | yes | yes |
| `GET` | `/api/v1/authorization_boundaries/:authorization_boundary_id/scan_runs` | `scan_runs#index` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
| `POST` | `/api/v1/authorization_boundaries/:authorization_boundary_id/scan_runs` | `scan_runs#create` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
| `GET` | `/api/v1/authorization_boundaries/:authorization_boundary_id/scan_runs/:id` | `scan_runs#show` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
| `GET` | `/api/v1/authorization_boundaries/:authorization_boundary_id/scanner_findings` | `scanner_findings#index` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
| `GET` | `/api/v1/scanner_findings/:id` | `scanner_findings#show` | [`hdf-triage.md`](endpoints/hdf-triage.md) | yes | yes |
| `GET` | `/api/v1/service_accounts` | `service_accounts#index` | [`service-accounts.md`](endpoints/service-accounts.md) | yes | yes |
| `POST` | `/api/v1/service_accounts` | `service_accounts#create` | [`service-accounts.md`](endpoints/service-accounts.md) | yes | yes |
| `DELETE` | `/api/v1/service_accounts/:id` | `service_accounts#destroy` | [`service-accounts.md`](endpoints/service-accounts.md) | yes | yes |
| `GET` | `/api/v1/service_accounts/:id` | `service_accounts#show` | [`service-accounts.md`](endpoints/service-accounts.md) | yes | yes |
| `PATCH/PUT` | `/api/v1/service_accounts/:id` | `service_accounts#update` | [`service-accounts.md`](endpoints/service-accounts.md) | yes | yes |
| `POST` | `/api/v1/service_accounts/:id/disable` | `service_accounts#disable` | [`service-accounts.md`](endpoints/service-accounts.md) | yes | yes |
| `POST` | `/api/v1/service_accounts/:id/enable` | `service_accounts#enable` | [`service-accounts.md`](endpoints/service-accounts.md) | yes | yes |
| `POST` | `/api/v1/service_accounts/:id/regenerate_token` | `service_accounts#regenerate_token` | [`service-accounts.md`](endpoints/service-accounts.md) | yes | yes |
...
| `GET` | `/api/v1/ssp_control_statements/:id` | `ssp_control_statements#show` | [`ssp-control-statements.md`](endpoints/ssp-control-statements.md) | yes | yes |
| `PATCH/PUT` | `/api/v1/ssp_control_statements/:id` | `ssp_control_statements#update` | [`ssp-control-statements.md`](endpoints/ssp-control-statements.md) | yes | yes |
| `GET` | `/api/v1/ssp_documents/:ssp_document_id/statements` | `ssp_control_statements#index` | [`ssp-control-statements.md`](endpoints/ssp-control-statements.md) | yes | yes |
...
| `POST` | `/api/v1/ssp_documents/:id/fields/import/confirm` | `ssp_documents#import_fields_confirm` | prose only — [`field-import.md`](endpoints/field-import.md) | yes | yes |
| `POST` | `/api/v1/ssp_documents/:id/fields/import/preview` | `ssp_documents#import_fields_preview` | prose only — [`field-import.md`](endpoints/field-import.md) | yes | yes |
...
| `GET` | `/api/v1/ssp_documents/:ssp_document_id/roles` | `ssp_roles#index` | [`ssp-roles.md`](endpoints/ssp-roles.md) | yes | yes |
| `POST` | `/api/v1/ssp_documents/:ssp_document_id/roles` | `ssp_roles#create` | [`ssp-roles.md`](endpoints/ssp-roles.md) | yes | yes |
| `DELETE` | `/api/v1/ssp_documents/:ssp_document_id/roles/:id` | `ssp_roles#destroy` | [`ssp-roles.md`](endpoints/ssp-roles.md) | yes | yes |
| `PATCH/PUT` | `/api/v1/ssp_documents/:ssp_document_id/roles/:id` | `ssp_roles#update` | [`ssp-roles.md`](endpoints/ssp-roles.md) | yes | yes |
