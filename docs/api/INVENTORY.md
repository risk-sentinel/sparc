...
- **Code:** **229 logical endpoints** across 46 controller groups (PATCH+PUT aliases collapsed) — 87 GET, 82 POST, 31 DELETE, 27 PUT, 25 PATCH
- **Documentation:** **186 / 229** endpoints are listed in an `endpoints/*.md` page's own Endpoints table (**81%**); 24 more are mentioned only in prose
- **Postman collection:** **221 / 229** endpoints covered (**97%**)
- **Pytest suite:** **190 / 229** endpoints map to a `tests/api/test_*.py` module (**83%**)
...
### No pytest module — 39 endpoints across 21 controllers
...
### Not in the Postman collection — 8 endpoints
...
| `GET` | `/api/v1/service_accounts` | `service_accounts#index` | [`service-accounts.md`](endpoints/service-accounts.md) | **MISSING** | yes |
| `POST` | `/api/v1/service_accounts` | `service_accounts#create` | [`service-accounts.md`](endpoints/service-accounts.md) | **MISSING** | yes |
| `DELETE` | `/api/v1/service_accounts/:id` | `service_accounts#destroy` | [`service-accounts.md`](endpoints/service-accounts.md) | **MISSING** | yes |
| `GET` | `/api/v1/service_accounts/:id` | `service_accounts#show` | [`service-accounts.md`](endpoints/service-accounts.md) | **MISSING** | yes |
| `PATCH/PUT` | `/api/v1/service_accounts/:id` | `service_accounts#update` | [`service-accounts.md`](endpoints/service-accounts.md) | **MISSING** | yes |
| `POST` | `/api/v1/service_accounts/:id/disable` | `service_accounts#disable` | [`service-accounts.md`](endpoints/service-accounts.md) | **MISSING** | yes |
| `POST` | `/api/v1/service_accounts/:id/enable` | `service_accounts#enable` | [`service-accounts.md`](endpoints/service-accounts.md) | **MISSING** | yes |
| `POST` | `/api/v1/service_accounts/:id/regenerate_token` | `service_accounts#regenerate_token` | [`service-accounts.md`](endpoints/service-accounts.md) | **MISSING** | yes |
