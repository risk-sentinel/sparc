...
- **Code:** **239 logical endpoints** across 47 controller groups (PATCH+PUT aliases collapsed) — 90 GET, 87 POST, 32 DELETE, 28 PUT, 26 PATCH
- **Documentation:** **196 / 239** endpoints are listed in an `endpoints/*.md` page's own Endpoints table (**82%**); 24 more are mentioned only in prose
- **Postman collection:** **229 / 239** endpoints covered (**96%**)
- **Pytest suite:** **197 / 239** endpoints map to a `tests/api/test_*.py` module (**82%**)
...
| `GET` | `/api/v1/organizations` | `organizations#index` | [`organizations.md`](endpoints/organizations.md) | **MISSING** | yes |
| `POST` | `/api/v1/organizations` | `organizations#create` | [`organizations.md`](endpoints/organizations.md) | **MISSING** | yes |
| `GET` | `/api/v1/organizations/:id` | `organizations#show` | [`organizations.md`](endpoints/organizations.md) | **MISSING** | yes |
| `PATCH/PUT` | `/api/v1/organizations/:id` | `organizations#update` | [`organizations.md`](endpoints/organizations.md) | **MISSING** | yes |
| `POST` | `/api/v1/organizations/:id/boundaries` | `organizations#assign_boundary` | [`organizations.md`](endpoints/organizations.md) | **MISSING** | **MISSING** |
| `POST` | `/api/v1/organizations/:id/deactivate` | `organizations#deactivate` | [`organizations.md`](endpoints/organizations.md) | **MISSING** | yes |
| `GET` | `/api/v1/organizations/:id/members` | `organizations#members` | [`organizations.md`](endpoints/organizations.md) | **MISSING** | yes |
| `POST` | `/api/v1/organizations/:id/members` | `organizations#add_member` | [`organizations.md`](endpoints/organizations.md) | **MISSING** | **MISSING** |
| `DELETE` | `/api/v1/organizations/:id/members/:membership_id` | `organizations#remove_member` | [`organizations.md`](endpoints/organizations.md) | **MISSING** | **MISSING** |
| `POST` | `/api/v1/organizations/:id/reactivate` | `organizations#reactivate` | [`organizations.md`](endpoints/organizations.md) | **MISSING** | yes |
