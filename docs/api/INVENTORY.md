...
- **Generated:** 2026-08-21 from `bin/rails routes` on this commit
...
| `DELETE` | `/api/v1/scanner_findings/:scanner_finding_id/disposition` | `finding_dispositions#destroy` | **MISSING** | yes | yes |
| `GET` | `/api/v1/scanner_findings/:scanner_finding_id/disposition` | `finding_dispositions#show` | **MISSING** | yes | yes |
