...
| `GET` | `/api/v1/control_catalogs/:control_catalog_id/control_families` | `control_families#index` | yes | no | yes |
| `POST` | `/api/v1/control_catalogs/:control_catalog_id/control_families` | `control_families#create` | yes | no | yes |
| `GET` | `/api/v1/control_catalogs/:control_catalog_id/control_families/:id` | `control_families#show` | yes | no | yes |
| `PATCH/PUT` | `/api/v1/control_catalogs/:control_catalog_id/control_families/:id` | `control_families#update` | yes | no | yes |
| `DELETE` | `/api/v1/control_catalogs/:control_catalog_id/control_families/:id` | `control_families#destroy` | yes | no | yes |
| `GET` | `/api/v1/control_catalogs/:control_catalog_id/control_families/:control_family_id/controls` | `catalog_controls#index` | yes | no | yes |
| `POST` | `/api/v1/control_catalogs/:control_catalog_id/control_families/:control_family_id/controls` | `catalog_controls#create` | yes | no | yes |
| `GET` | `/api/v1/control_catalogs/:control_catalog_id/controls` | `catalog_controls#index` | yes | no | yes |
| `GET` | `/api/v1/control_catalogs/:control_catalog_id/controls/:id` | `catalog_controls#show` | yes | no | yes |
| `PATCH/PUT` | `/api/v1/control_catalogs/:control_catalog_id/controls/:id` | `catalog_controls#update` | yes | no | yes |
| `DELETE` | `/api/v1/control_catalogs/:control_catalog_id/controls/:id` | `catalog_controls#destroy` | yes | no | yes |
