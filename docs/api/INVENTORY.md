...
- **Code:** **279 logical endpoints** across 55 controller groups (PATCH+PUT aliases collapsed) — 106 GET, 96 POST, 40 DELETE, 35 PUT, 33 PATCH
- **Documentation:** **206 / 279** endpoints are listed in an `endpoints/*.md` page's own Endpoints table (**74%**); 24 more are mentioned only in prose
- **Postman collection:** **249 / 279** endpoints covered (**89%**)
- **Pytest suite:** **204 / 279** endpoints map to a `tests/api/test_*.py` module (**73%**)
...
### Documented nowhere — 49 endpoints
...
| `GET` | `/api/v1/poam_documents/:poam_document_id/findings` | `poam_findings#index` |
| `POST` | `/api/v1/poam_documents/:poam_document_id/findings` | `poam_findings#create` |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/findings/:id` | `poam_findings#destroy` |
| `GET` | `/api/v1/poam_documents/:poam_document_id/findings/:id` | `poam_findings#show` |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/findings/:id` | `poam_findings#update` |
| `GET` | `/api/v1/poam_documents/:poam_document_id/items` | `poam_items#index` |
| `POST` | `/api/v1/poam_documents/:poam_document_id/items` | `poam_items#create` |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/items/:id` | `poam_items#destroy` |
| `GET` | `/api/v1/poam_documents/:poam_document_id/items/:id` | `poam_items#show` |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/items/:id` | `poam_items#update` |
| `GET` | `/api/v1/poam_documents/:poam_document_id/local_components` | `poam_local_components#index` |
| `POST` | `/api/v1/poam_documents/:poam_document_id/local_components` | `poam_local_components#create` |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/local_components/:id` | `poam_local_components#destroy` |
| `GET` | `/api/v1/poam_documents/:poam_document_id/local_components/:id` | `poam_local_components#show` |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/local_components/:id` | `poam_local_components#update` |
| `GET` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones` | `poam_milestones#index` |
| `POST` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones` | `poam_milestones#create` |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones/:id` | `poam_milestones#destroy` |
| `GET` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones/:id` | `poam_milestones#show` |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones/:id` | `poam_milestones#update` |
| `GET` | `/api/v1/poam_documents/:poam_document_id/observations` | `poam_observations#index` |
| `POST` | `/api/v1/poam_documents/:poam_document_id/observations` | `poam_observations#create` |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/observations/:id` | `poam_observations#destroy` |
| `GET` | `/api/v1/poam_documents/:poam_document_id/observations/:id` | `poam_observations#show` |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/observations/:id` | `poam_observations#update` |
| `GET` | `/api/v1/poam_documents/:poam_document_id/remediations` | `poam_remediations#index` |
| `POST` | `/api/v1/poam_documents/:poam_document_id/remediations` | `poam_remediations#create` |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/remediations/:id` | `poam_remediations#destroy` |
| `GET` | `/api/v1/poam_documents/:poam_document_id/remediations/:id` | `poam_remediations#show` |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/remediations/:id` | `poam_remediations#update` |
...
### No pytest module — 75 endpoints across 29 controllers

| Controller | Endpoints | Module looked for |
|---|---|---|
| `finding_dispositions` | 5 | `tests/api/test_finding_dispositions.py` |
| `poam_findings` | 5 | `tests/api/test_poam_findings.py` |
| `poam_items` | 5 | `tests/api/test_poam_items.py` |
| `poam_local_components` | 5 | `tests/api/test_poam_local_components.py` |
| `poam_milestones` | 5 | `tests/api/test_poam_milestones.py` |
| `poam_observations` | 5 | `tests/api/test_poam_observations.py` |
| `poam_remediations` | 5 | `tests/api/test_poam_remediations.py` |
| `cdef_coverage` | 3 | `tests/api/test_cdef_coverage.py` |
| `cdef_documents` | 3 | `tests/api/test_cdef_documents.py` |
| `converter_entries` | 3 | `tests/api/test_converter_entries.py` |
...
| `leveraged_authorizations` | 1 | `tests/api/test_leveraged_authorizations.py` |
...
### Not in the Postman collection — 30 endpoints

| Controller | Endpoints |
|---|---|
| `poam_findings` | 5 |
| `poam_items` | 5 |
| `poam_local_components` | 5 |
| `poam_milestones` | 5 |
| `poam_observations` | 5 |
| `poam_remediations` | 5 |
...
| `GET` | `/api/v1/converters/:converter_id/entries` | `converter_entries#index` | [`converters.md`](endpoints/converters.md) | yes | **MISSING** |
| `POST` | `/api/v1/converters/:converter_id/entries` | `converter_entries#create` | [`converters.md`](endpoints/converters.md) | yes | **MISSING** |
| `DELETE` | `/api/v1/converters/:converter_id/entries/:id` | `converter_entries#destroy` | [`converters.md`](endpoints/converters.md) | yes | **MISSING** |
...
| `POST` | `/api/v1/authorization_boundaries/:authorization_boundary_id/leveraged_authorizations/:id/populate` | `leveraged_authorizations#populate` | [`leveraged-authorizations.md`](endpoints/leveraged-authorizations.md) | yes | **MISSING** |
...
| `GET` | `/api/v1/poam_documents/:poam_document_id/findings` | `poam_findings#index` | **MISSING** | **MISSING** | **MISSING** |
| `POST` | `/api/v1/poam_documents/:poam_document_id/findings` | `poam_findings#create` | **MISSING** | **MISSING** | **MISSING** |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/findings/:id` | `poam_findings#destroy` | **MISSING** | **MISSING** | **MISSING** |
| `GET` | `/api/v1/poam_documents/:poam_document_id/findings/:id` | `poam_findings#show` | **MISSING** | **MISSING** | **MISSING** |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/findings/:id` | `poam_findings#update` | **MISSING** | **MISSING** | **MISSING** |
| `GET` | `/api/v1/poam_documents/:poam_document_id/items` | `poam_items#index` | **MISSING** | **MISSING** | **MISSING** |
| `POST` | `/api/v1/poam_documents/:poam_document_id/items` | `poam_items#create` | **MISSING** | **MISSING** | **MISSING** |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/items/:id` | `poam_items#destroy` | **MISSING** | **MISSING** | **MISSING** |
| `GET` | `/api/v1/poam_documents/:poam_document_id/items/:id` | `poam_items#show` | **MISSING** | **MISSING** | **MISSING** |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/items/:id` | `poam_items#update` | **MISSING** | **MISSING** | **MISSING** |
| `GET` | `/api/v1/poam_documents/:poam_document_id/local_components` | `poam_local_components#index` | **MISSING** | **MISSING** | **MISSING** |
| `POST` | `/api/v1/poam_documents/:poam_document_id/local_components` | `poam_local_components#create` | **MISSING** | **MISSING** | **MISSING** |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/local_components/:id` | `poam_local_components#destroy` | **MISSING** | **MISSING** | **MISSING** |
| `GET` | `/api/v1/poam_documents/:poam_document_id/local_components/:id` | `poam_local_components#show` | **MISSING** | **MISSING** | **MISSING** |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/local_components/:id` | `poam_local_components#update` | **MISSING** | **MISSING** | **MISSING** |
| `GET` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones` | `poam_milestones#index` | **MISSING** | **MISSING** | **MISSING** |
| `POST` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones` | `poam_milestones#create` | **MISSING** | **MISSING** | **MISSING** |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones/:id` | `poam_milestones#destroy` | **MISSING** | **MISSING** | **MISSING** |
| `GET` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones/:id` | `poam_milestones#show` | **MISSING** | **MISSING** | **MISSING** |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/remediations/:remediation_id/milestones/:id` | `poam_milestones#update` | **MISSING** | **MISSING** | **MISSING** |
| `GET` | `/api/v1/poam_documents/:poam_document_id/observations` | `poam_observations#index` | **MISSING** | **MISSING** | **MISSING** |
| `POST` | `/api/v1/poam_documents/:poam_document_id/observations` | `poam_observations#create` | **MISSING** | **MISSING** | **MISSING** |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/observations/:id` | `poam_observations#destroy` | **MISSING** | **MISSING** | **MISSING** |
| `GET` | `/api/v1/poam_documents/:poam_document_id/observations/:id` | `poam_observations#show` | **MISSING** | **MISSING** | **MISSING** |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/observations/:id` | `poam_observations#update` | **MISSING** | **MISSING** | **MISSING** |
| `GET` | `/api/v1/poam_documents/:poam_document_id/remediations` | `poam_remediations#index` | **MISSING** | **MISSING** | **MISSING** |
| `POST` | `/api/v1/poam_documents/:poam_document_id/remediations` | `poam_remediations#create` | **MISSING** | **MISSING** | **MISSING** |
| `DELETE` | `/api/v1/poam_documents/:poam_document_id/remediations/:id` | `poam_remediations#destroy` | **MISSING** | **MISSING** | **MISSING** |
| `GET` | `/api/v1/poam_documents/:poam_document_id/remediations/:id` | `poam_remediations#show` | **MISSING** | **MISSING** | **MISSING** |
| `PATCH/PUT` | `/api/v1/poam_documents/:poam_document_id/remediations/:id` | `poam_remediations#update` | **MISSING** | **MISSING** | **MISSING** |
