...
- **Generated:** 2026-09-12 from `bin/rails routes` on this commit
- **Code:** **302 logical endpoints** across 60 controller groups (PATCH+PUT aliases collapsed) — 117 GET, 103 POST, 42 DELETE, 38 PUT, 36 PATCH
- **Documentation:** **286 / 302** endpoints are listed in an `endpoints/*.md` page's own Endpoints table (**95%**); 16 more are mentioned only in prose
- **Postman collection:** **302 / 302** endpoints covered (**100%**)
- **Pytest suite:** **302 / 302** endpoints map to a `tests/api/test_*.py` module (**100%**)
