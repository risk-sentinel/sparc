...
- **Code:** **216 logical endpoints** across 44 controller groups (PATCH+PUT aliases collapsed) — 83 GET, 77 POST, 29 DELETE, 25 PUT, 23 PATCH
- **Documentation:** **173 / 216** endpoints are listed in an `endpoints/*.md` page's own Endpoints table (**80%**); 24 more are mentioned only in prose
- **Postman collection:** **211 / 216** endpoints covered (**98%**)
- **Pytest suite:** **177 / 216** endpoints map to a `tests/api/test_*.py` module (**82%**)
...
| `GET` | `/api/v1/authorization_boundaries/:authorization_boundary_id/leveraged_authorizations` | `leveraged_authorizations#index` | [`leveraged-authorizations.md`](endpoints/leveraged-authorizations.md) | **MISSING** | yes |
| `POST` | `/api/v1/authorization_boundaries/:authorization_boundary_id/leveraged_authorizations` | `leveraged_authorizations#create` | [`leveraged-authorizations.md`](endpoints/leveraged-authorizations.md) | **MISSING** | yes |
| `DELETE` | `/api/v1/authorization_boundaries/:authorization_boundary_id/leveraged_authorizations/:id` | `leveraged_authorizations#destroy` | [`leveraged-authorizations.md`](endpoints/leveraged-authorizations.md) | **MISSING** | yes |
| `GET` | `/api/v1/authorization_boundaries/:authorization_boundary_id/leveraged_authorizations/:id` | `leveraged_authorizations#show` | [`leveraged-authorizations.md`](endpoints/leveraged-authorizations.md) | **MISSING** | yes |
| `POST` | `/api/v1/authorization_boundaries/:authorization_boundary_id/leveraged_authorizations/:id/populate` | `leveraged_authorizations#populate` | [`leveraged-authorizations.md`](endpoints/leveraged-authorizations.md) | **MISSING** | **MISSING** |
