...
- **Generated:** 2026-09-13 from `bin/rails routes` on this commit
- **Code:** **306 logical endpoints** across 61 controller groups (PATCH+PUT aliases collapsed) — 118 GET, 104 POST, 43 DELETE, 39 PUT, 37 PATCH
- **Documentation:** **290 / 306** endpoints are listed in an `endpoints/*.md` page's own Endpoints table (**95%**); 16 more are mentioned only in prose
- **Postman collection:** **306 / 306** endpoints covered (**100%**)
- **Pytest suite:** **306 / 306** endpoints map to a `tests/api/test_*.py` module (**100%**)
...
### Mentioned in prose but not published — 16 endpoints
