...
- **Generated:** 2026-09-01 from `bin/rails routes` on this commit
- **Code:** **298 logical endpoints** across 58 controller groups (PATCH+PUT aliases collapsed) — 114 GET, 103 POST, 42 DELETE, 37 PUT, 35 PATCH
- **Documentation:** **283 / 298** endpoints are listed in an `endpoints/*.md` page's own Endpoints table (**95%**); 15 more are mentioned only in prose
- **Postman collection:** **298 / 298** endpoints covered (**100%**)
- **Pytest suite:** **298 / 298** endpoints map to a `tests/api/test_*.py` module (**100%**)
...
### Mentioned in prose but not published — 15 endpoints
