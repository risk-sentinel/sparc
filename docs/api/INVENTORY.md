...
- **Code:** **249 logical endpoints** across 49 controller groups (PATCH+PUT aliases collapsed) — 94 GET, 90 POST, 34 DELETE, 29 PUT, 27 PATCH
- **Documentation:** **206 / 249** endpoints are listed in an `endpoints/*.md` page's own Endpoints table (**83%**); 24 more are mentioned only in prose
- **Postman collection:** **239 / 249** endpoints covered (**96%**)
- **Pytest suite:** **204 / 249** endpoints map to a `tests/api/test_*.py` module (**82%**)
...
### No pytest module — 45 endpoints across 23 controllers
...
### Not in the Postman collection — 10 endpoints
...
| `GET` | `/api/v1/converters/:converter_id/entries` | `converter_entries#index` | [`converters.md`](endpoints/converters.md) | **MISSING** | **MISSING** |
| `POST` | `/api/v1/converters/:converter_id/entries` | `converter_entries#create` | [`converters.md`](endpoints/converters.md) | **MISSING** | **MISSING** |
| `DELETE` | `/api/v1/converters/:converter_id/entries/:id` | `converter_entries#destroy` | [`converters.md`](endpoints/converters.md) | **MISSING** | **MISSING** |
| `GET` | `/api/v1/converters` | `converters#index` | [`converters.md`](endpoints/converters.md) | **MISSING** | yes |
| `POST` | `/api/v1/converters` | `converters#create` | [`converters.md`](endpoints/converters.md) | **MISSING** | yes |
| `DELETE` | `/api/v1/converters/:id` | `converters#destroy` | [`converters.md`](endpoints/converters.md) | **MISSING** | yes |
| `GET` | `/api/v1/converters/:id` | `converters#show` | [`converters.md`](endpoints/converters.md) | **MISSING** | yes |
| `PATCH/PUT` | `/api/v1/converters/:id` | `converters#update` | [`converters.md`](endpoints/converters.md) | **MISSING** | yes |
| `GET` | `/api/v1/converters/:id/export` | `converters#export` | [`converters.md`](endpoints/converters.md) | **MISSING** | yes |
| `POST` | `/api/v1/converters/:id/refresh` | `converters#refresh` | [`converters.md`](endpoints/converters.md) | **MISSING** | yes |
