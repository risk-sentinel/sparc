...
hdf version  # 3.1.0 or compatible
```
...
HDF_LIBS_VERSION=3.1.0 bin/install-hdf.sh
...
- [HDF Amendments schema v3.1.0](https://mitre.github.io/hdf-libs/schemas/hdf-amendments/v3.1.0/)
