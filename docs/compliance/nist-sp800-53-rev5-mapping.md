...
| RA-3(1) | Supply Chain Risk Assessment | H | Hybrid | SBOM generation; dependency vulnerability scanning; SBOM-driven SCA via Grype (#461); supply chain analysis | `.github/workflows/security.yml` (sbom_generation, dependency_audit, grype_sbom_scan) | Implemented |
...
| SR-3 | Supply Chain Controls and Processes | H | Hybrid | CycloneDX SBOM generation; dependency auditing; container scanning; SBOM-driven vulnerability scanning via Grype (#461) — published SBOMs are scan-verified before release, not just generated; known-good version pinning | `.github/workflows/security.yml`, `Gemfile.lock` | Implemented |
