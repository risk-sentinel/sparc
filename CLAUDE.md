...
- `docs/dev/Implementation_plan.md` — **live** roadmap: current/next phases and the open-issue audit
- `docs/dev/implemented.md` — **archive**: Phases 1–16, shipped through v1.16.0 (history, not a plan)
