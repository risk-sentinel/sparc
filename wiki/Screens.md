...
4. **Control cards** -- each card shows:
   ...
   - Edit button toggling an inline edit form with dropdowns for status, type_use_as, provided_as, control_origination, date picker for expected_completion, and text areas for other fields
...
6. **Control cards** (paginated, 50 per page):
   ...
   - Collapsible details with:
     ...
     - Ordered field table: date, tester, notes/weakness, recommended fix, working comments, working status, provided_as, inherited, row number
