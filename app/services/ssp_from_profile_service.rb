...
# (status, control_origination, responsible_entities, etc.).
#
  ...
  def build_controls_from_catalog(catalog)
    ...
    groups.each do |group|
      (group["controls"] || []).each do |control|
        ...
        field_entries << [ idx, "control_origination", "" ]
        field_entries << [ idx, "responsible_entities", "" ]
        field_entries << [ idx, "private_implementation", "" ]
        field_entries << [ idx, "public_implementation", "" ]
