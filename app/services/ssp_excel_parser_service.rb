...
class SspExcelParserService
  ...
  COLUMN_MAP = {
    ...
    "private implementation" => { key: "implementation_statement", control_attr: false },
    "public implementation"  => { key: "implementation_summary",  control_attr: false },
    ...
    "type/use as"            => { key: "control_application",            control_attr: false },
    "inherited from"         => { key: "inherited_from",         control_attr: false },
    "provided as"            => { key: "coverage_level",            control_attr: false },
    "control origination"    => { key: "control_type",    control_attr: false },
