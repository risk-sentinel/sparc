...
ActiveRecord::Schema[8.1].define(version: 2026_09_01_162544) do
  ...
  create_table "back_matter_resources", force: :cascade do |t|
    ...
    t.string "provided_by_contact"
    t.string "provided_by_team"
  ...
  create_table "control_catalogs", force: :cascade do |t|
    ...
    t.index ["framework"], name: "index_control_catalogs_on_framework"
  ...
  create_table "data_migration_runs", force: :cascade do |t|
    ...
    t.index ["name"], name: "index_data_migration_runs_on_name", unique: true
  ...
  create_table "profile_documents", force: :cascade do |t|
    ...
    t.index ["framework"], name: "index_profile_documents_on_framework"
